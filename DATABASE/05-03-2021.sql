...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2021 at 02:32 AM
...
CREATE TABLE `asset` (
  ...
  `origin_location` int(1) NOT NULL,
  `asset_location` int(1) NOT NULL,
...
(163, 'asd', 'asd', 1, 'M-2022021031', 0, 4, 0);
...
INSERT INTO `rooms` (`id`, `name`, `status`, `created_at`, `updated_at`, `building_id`) VALUES
...
(5, 'IT', 'Ardiyan Agus', 'admin', 'bnb241.jpg', '$2y$10$rG8laZTf834cETwyuxcEfOX2YIgBdwiRjK0867f3Y5lY8602VLid2', 1, 1, 1572444578),
...
(11, 1, 'Data Ruangan', 'admin/buildings', 'fas fa-fw fa-coins'),
...
--
ALTER TABLE `asset`
  MODIFY `id_asset` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
