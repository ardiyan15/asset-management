                        ...
                        <?php foreach ($asset as $ast) : ?>
                            <tr>
                                ...
                                <td class="text-center" scope="col">
                                    <a href="<?= base_url('TI/acc/') . $ast['id'] ?>" class="btn btn-success btn-sm takein-button rounded"> <i class="fas fa-check"></i> Terima </a>
                                    <a href="<?= base_url('TI/reject/') . $ast['id'] ?>" class="btn btn-danger btn-sm reject-button rounded"> <i class=" fas fa-times"></i> Tolak </a>
                                </td>
