			...
			<div class="card border-left-success shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Aset</div>
		...
		<form action="<?= base_url('admin/index'); ?>" method="POST">
			<div class="card shadow">
				<div class="card-header d-flex">
					<h5 class="align-items-center">Data Aset</h5>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
						...
						<div class="text-right col-md-6" style="margin-top: 0.1rem;">
