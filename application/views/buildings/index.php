<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            <h3> <?= $title; ?> </h3>
            <?php if ($role_id == '1'): ?>
                <a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addStrLocation"> <i
                        class="fas fa-plus mr-1"></i> Tambah Bangunan Baru </a>
            <?php endif; ?>
        </div>
    </div>
                ...
                <a href="<?= base_url('floors/') . $building['id'] ?>">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('buildings/edit/') . $building['id'] ?>" class="btn btn-default btn-sm">
            ...
            <form method="post" action="<?= base_url('Admin/add_building_location'); ?>">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Bangunan"
                            required>
                    </div>
