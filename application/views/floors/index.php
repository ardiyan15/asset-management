<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?php if ($role_id == '1'): ?>
                <a href="" class="btn btn-success btn-sm rounded" data-toggle="modal" data-target="#addStrLocation"> <i
                        class="fas fa-plus mr-1"></i> Tambah Lantai Baru </a>
            <?php endif; ?>
        </div>
    </div>
                ...
                <a href="<?= base_url('room/') . $floor['id'] ?>">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('floors/edit/') . $floor['id'] ?>" class="btn btn-default btn-sm"> <i
    ...
    <a href="<?= base_url('buildings') ?>" class="btn btn-sm btn-secondary rounded mt-3">Kembali</a>
</div>
            ...
            <form method="post" action="<?= base_url('Floors/store'); ?>">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Lantai"
                            required>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-sm btn-success rounded"><i
